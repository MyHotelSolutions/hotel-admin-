        ...
        <div class="flex flex-col justify-center items-center w-[50vw] h-full relative">
            <div class="w-full">
                <Card class="max-w-sm w-full p-6 mx-auto">
                        ...
                        <Input placeholder="new password" type="password" v-model="passwordOne"/>
                        <Input placeholder="Re-enter password" type="password" v-model="passwordTwo"/>
                    <Button @click="resetPassword">Send Code</Button>
                </Card>
            </div>
...
const resetPassword = () => {
    if(passwordOne.value != passwordTwo.value){
        toastMessage('error', "Password not mached", "Your first and second passwords are not mached")
    }else{
